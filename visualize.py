...
class Animation:
    def __init__(self, my_map, starts, goals, paths):
        ...
        self.patches.append(Rectangle((x_min, y_min), x_max - x_min, y_max - y_min, facecolor='white', edgecolor='black'))
    ...
    def animate_func(self, t):
        ...
        for i in range(0, len(agents_array)):
            for j in range(i + 1, len(agents_array)):
                d1 = agents_array[i]
                d2 = agents_array[j]
                # d1.set_facecolor(d1.original_face_color)
                # d2.set_facecolor(d2.original_face_color)
